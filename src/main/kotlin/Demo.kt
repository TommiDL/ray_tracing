    ...
    fun declare_world():World
    {
        ...
        val objs:MutableList<Shape> = mutableListOf(
            ...
            Plane(
                ...
                material = Material(
                    emitted_radiance = CheckeredPigment(Color(r=5f, g=5f), Color(b=5f), n_steps = 12),
                    brdf = DiffusiveBRDF(CheckeredPigment(Color(r=15f, g=15f), Color(b=15f), n_steps = 12))
                )
            ),

            Sphere(
                transformation = traslation(Vec(z=0.5f))* scalar_transformation(0.5f),
                material = Material(
            ...
            //specchio
            Sphere(
                transformation = traslation(Vec(z=1.5f)),
                material = Material(
